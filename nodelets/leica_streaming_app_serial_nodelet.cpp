...
LeicaStreamingAppSerialNodelet::LeicaStreamingAppSerialNodelet()
  : ts_(std::bind(&LeicaStreamingAppSerialNodelet::locationTSCallback, this, std::placeholders::_1,
...
void LeicaStreamingAppSerialNodelet::onInit()
{
  ...
  prism_pos_pub_ = nh_.advertise<geometry_msgs::PointStamped>(
      "/leica/position", 10, boost::bind(&LeicaStreamingAppSerialNodelet::connectCb, this),
...
void LeicaStreamingAppSerialNodelet::locationTSCallback(const double x, const double y, const double z)
{
  /*
